...
test("order phases for happy path", async () => {
  ...
  // find and click oder summary button
  ...
  // accept terms and condition click button
  ...
  // this one is async because there is a POST request to serve in between summary
